...
exports.getUserProfile = async (param, res) => {
    ...
    try {
        ...
        req.userId = req.userId === undefined || req.userId === "" ? param.userId : req.userId;
...
exports.getUsers = async (param, res) => {
    ...
    try {
        ...
        return res.status(200).json({
            isSuccess: false,
            message: "Something Wrong in System, Please Contact Administrator!" + error.message
        })
    }
}
...
exports.getFollowing = async (param, res) => {
    ...
    try {
        var req = param.body;
        req.userId = req.userId === '' || req.userId === undefined ? param.userId : req.userId;
                                ...
                                if (rtnRole != null) {
                                    if (rtnRole.affectedRows > 0) {
                                        ...
                                        if (ins_dtls.affectedRows > 0) {
                                            ...
                                            // Direct login
                                            await users.loginUserSSOCallback(req.email, "", req.source, res, this.processLogin);
                                        }
                                        else {
                                            return res.status(200).json({
                                                isSuccess: false,
...
exports.submitProfile = async (param, res) => {
    ...
    try {
        ...
        form.parse(param, async (err, fields, files) => {
            ...
            return res.status(200).json({
                isSuccess: false,
                message: "Failed Update Profile, mypic parameter is not included, please include while is filled or not "
            });
        });
    } catch (error) {
        console.log(error.message);
...
exports.followUser = async (param, res) => {
    try {
        ...
        var cek = await users.checkFollow(req);
        if (cek.length > 0) {
            var upd = await users.activatedfollowUser(req);
            if (upd.affectedRows > 0) {
        ...
        return res.status(200).json(responseHelper.FailWithMessage('Failed to follow user, pelase contact Administrator.!'))
    } catch (error) {
        console.log(error.message);
        return res.status(200).json(responseHelper.Fail());
    }
...
exports.notifyUsers = async (param, res) => {
    try {
        ...
        return res.status(200).json(responseHelper.FailWithMessage('Failed to add notify, please contact Adminstrator!'))
    } catch (error) {
        console.log(error.message);
        return res.status(200).json(responseHelper.Fail());
    }
...
exports.connectGoogle = async (param, res) => {
    try {
        ...
        if (item.length > 0) {
            return res.status(200).json(responseHelper.FailWithMessage('This google account already connected with other user'));
        }
        var ins = await users.connectGoogle(req);
        if (ins.affectedRows > 0) {
            return res.status(200).json(responseHelper.SuccessWithEmptyData());
        }
        return res.status(200).json(responseHelper.FailWithMessage('Failed to connect google. please contact Administrator!'))
    } catch (error) {
        console.log(error.message);
        return res.status(200).json(responseHelper.Fail())
    }
...
exports.connectFacebook = async (param, res) => {
    try {
        ...
        if (item.length > 0) {
            return res.status(200).json(responseHelper.FailWithMessage('This facebook account already connected with other user'));
        }
        var ins = await users.connectFacebook(req);
        if (ins.affectedRows > 0) {
            return res.status(200).json(responseHelper.SuccessWithEmptyData());
        }
        return res.status(200).json(responseHelper.FailWithMessage('Failed to connect facebook. please contact Adminstrator!'))
    } catch (error) {
        console.log(error.message);
        return res.status(200).json(responseHelper.Fail());
    }
...
exports.disableUser = async (param, res) => {
    try {
        ...
        return res.status(200).json(responseHelper.FailWithMessage('Failed to disable user, please contact Administrator!'));
    } catch (error) {
        console.log(error.message);
        return res.status(200).json(responseHelper.Fail());
    }
...
exports.enableUser = async (param, res) => {
    try {
        ...
        return res.status(200).json(responseHelper.FailWithMessage('Failed to enable user, please contact Administrator!'));
    } catch (error) {
        console.log(error.message);
        return res.status(200).json(responseHelper.Fail());
    }
